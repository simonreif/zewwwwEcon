...
presenter: "Name" # Write name if it should appear on the bottom of every slide
date: today
...
\end{equation}
```
These equations minimize the sum of squared residuals $S$. While this seems promising, others argue that this has been done before. It might even work with real-world data [@stern2022, LancetDH; @abadieSemiparametric2005, REStud].
:::
:::

## Highlighting and References

Sometimes it seems that not only are people putting books from boxes but also like boxes around some highlight text. An example would be something you (can not) find in @stern2022 [LancetDH]:
