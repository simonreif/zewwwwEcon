...
\usepackage{booktabs, longtable, colortbl}
...
% Image search path: extension assets first, then document directory for user images

\graphicspath{{$images-path$}{./}}
\usetikzlibrary{decorations.pathreplacing,calc}

\usepackage{lmodern, multirow}
\usepackage{iftex}
...
\definecolor{quarto-callout-color}{HTML}{b4be28}
\definecolor{quarto-callout-note-color}{HTML}{b4be28}
\definecolor{quarto-callout-important-color}{HTML}{CC1914}
\definecolor{quarto-callout-warning-color}{HTML}{EB9113}
\definecolor{quarto-callout-tip-color}{HTML}{527DA4}
\definecolor{quarto-callout-caution-color}{HTML}{FC5300}
\definecolor{quarto-callout-color-frame}{HTML}{acacac}
\definecolor{quarto-callout-note-color-frame}{HTML}{b4be28}
\definecolor{quarto-callout-important-color-frame}{HTML}{d9534f}
\definecolor{quarto-callout-warning-color-frame}{HTML}{f0ad4e}
\definecolor{quarto-callout-tip-color-frame}{HTML}{D0E8EC}
...
\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{bgmain.pdf}}
...
\usebackgroundtemplate{\includegraphics[width=\paperwidth,height=\paperheight]{bgtitle.png}}
\begin{frame}[c]

\begin{tikzpicture}[remember picture,overlay]
  \node[anchor=south west,inner sep=0pt] at (-0.2,2.5) {
   \includegraphics[height=0.7cm]{yourlogo.png}
  };
  \node[anchor=south west,inner sep=0pt] at (-0.2,1.8) {
   \includegraphics[height=0.7cm]{$partner-logo$}
  };
\end{tikzpicture}
\begin{tikzpicture}
