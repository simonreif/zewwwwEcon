---
title: "zewEcon: A Template for Econ Articles with Quarto"
pdf-engine: xelatex
author:
  - name: Lord Macbeth
    affiliation:
...
date: today # Alternatively, enter a date as "1 May 2026"
...
:::: {#fig-eventstudy2 fig-pos="H" fig-cap="An event-study plot in the Appendix"}
```{r eventstudy2}
#| echo: false 
#| warning: false
#| message: false
...
```
::: {.notes-block}
**Notes:** You can use this text to provide further information about the plot. Nunc sed pede. Praesent vitaelectus. Praesent neque justo, vehicula eget, interdum id, facilisis et, nibh. Phasellus at purus et libero laciniadictum. Fusce aliquet. Nulla eu ante placerat leo semper dictum. Mauris metus. Curabitur lobortis. Curabitursollicitudin hendrerit nunc. Donec ultrices lacus id ipsum. 
:::
::::
