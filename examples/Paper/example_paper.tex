...
\caption{\label{fig-eventstudy2}An event-study plot in the Appendix}

\centering{

\pandocbounded{\includegraphics[keepaspectratio]{example_paper_files/figure-pdf/eventstudy2-1.pdf}}
